"""
Minimal POC: extract ADA profile URLs from ADA_Public_Profile_Dataset.xlsx via
the Tavily Extract API and dump the complete, unmodified raw JSON responses.
"""
...
INPUT_PATH = "ADA_Public_Profile_Dataset.xlsx"
URL_COLUMN = "Profile_Link"
OUTPUT_PATH = "ada_tavily_raw_output.json"
...
def main():
    ...
    print(f"Loaded {len(urls)} unique profile URLs from {INPUT_PATH}")
