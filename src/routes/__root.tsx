...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Global3 — Owner Dashboard" },
      { name: "description", content: "Global3 recruitment automation — owner oversight dashboard for lead health, recruiter performance, and language coverage." },
      { name: "author", content: "Global3" },
      { property: "og:title", content: "Global3 — Owner Dashboard" },
      { property: "og:description", content: "Global3 recruitment automation — owner oversight dashboard for lead health, recruiter performance, and language coverage." },
